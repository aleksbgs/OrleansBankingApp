...
[StatelessWorker]
public class StatlessTransferProcessingGrain : Grain, ITransferProcessingGrain
{
    private readonly ITransactionClient _transactionClient;
    private readonly IPersistentState<TransferState> _transferState;


    public StatlessTransferProcessingGrain(ITransactionClient transactionClient,
